  ...
  return (
    <KeyboardControls map={keyBoardMap}>
      ...
      <Canvas shadows
        ...
        <Teleport users={props.users} occupiedWebCamTVs={props.occupiedWebCamTVs} tvLink={props.tvLink} isMovementAllowed={props.isMovementAllowed} roomMode={props.roomMode} setLocalAudioTrack={props.setLocalAudioTrack} isFirstPersonView={props.isFirstPersonView} setIsFirstPersonView={props.setIsFirstPersonView} />
      </Canvas>
    </KeyboardControls>
  )
}
