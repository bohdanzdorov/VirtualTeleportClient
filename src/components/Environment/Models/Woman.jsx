...
Command: npx gltfjsx@6.5.3 public/models/woman.glb -o src/components/Woman.jsx -r public 
*/
...
export function Woman({ animation, hasStream, ...props }) {
  const group = useRef()
  const { scene, materials, animations } = useGLTF('/models/woman.glb')
